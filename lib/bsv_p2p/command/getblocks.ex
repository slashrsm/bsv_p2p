defmodule BsvP2p.Command.Getblocks do
  @moduledoc """
  Bitcoin P2P "getblocks" command.
  """
  alias BSV.Util
  ...
  defimpl BsvP2p.Command, for: __MODULE__ do
    @spec name(BsvP2p.Command.Getblocks.t()) :: String.t()
    def name(_), do: "getblocks"

    @spec get_payload(BsvP2p.Command.Getblocks.t()) :: binary
    def get_payload(%BsvP2p.Command.Getblocks{
          version: version,
