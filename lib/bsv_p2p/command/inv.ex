defmodule BsvP2p.Command.Inv do
  @moduledoc """
  Bitcoin P2P "inv" command.
  """
  ...
  defimpl BsvP2p.Command, for: __MODULE__ do
    @spec name(BsvP2p.Command.Inv.t()) :: String.t()
    def name(_), do: "inv"

    @spec get_payload(BsvP2p.Command.Inv.t()) :: binary
    def get_payload(%BsvP2p.Command.Inv{vectors: vectors}) do
