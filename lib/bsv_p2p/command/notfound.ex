defmodule BsvP2p.Command.Notfound do
  @moduledoc """
  Bitcoin P2P "notfound" command.
  """
  ...
  defimpl BsvP2p.Command, for: __MODULE__ do
    @spec name(BsvP2p.Command.Notfound.t()) :: String.t()
    def name(_), do: "notfound"

    @spec get_payload(BsvP2p.Command.Notfound.t()) :: binary
    def get_payload(%BsvP2p.Command.Notfound{vectors: vectors}) do
